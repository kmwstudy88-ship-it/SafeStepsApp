...
- If a resumed session, saved plan, or prior instruction references a retired or unavailable explicit model choice, clear it and continue with `auto` or another currently supported runtime model.
