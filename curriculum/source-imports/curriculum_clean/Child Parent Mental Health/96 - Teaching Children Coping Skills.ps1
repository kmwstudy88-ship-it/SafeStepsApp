# ==================================================
# LESSON 96 - Teaching Children Coping Skills
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "96"
    Title = "Teaching Children Coping Skills"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Teaching Children Coping Skills",
    ...
    Introduction = @'
This lesson explores Teaching Children Coping Skills within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Teaching Children Coping Skills
...
- Teaching Children Coping Skills explanation
