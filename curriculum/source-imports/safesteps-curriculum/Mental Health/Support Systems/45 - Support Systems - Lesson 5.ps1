# ==================================================
# LESSON 45 - Support Systems - Lesson 5
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "45"
    Title = "Support Systems - Lesson 5"
...
It explores Support Systems in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Support Systems in real-world context.
...
A real-world scenario shows how Support Systems impacts behaviour and decision making.
