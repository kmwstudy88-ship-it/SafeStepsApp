# ==================================================
# LESSON 9 - Depression - Lesson 4
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "9"
    Title = "Depression - Lesson 4"
    Category = "Depression"
...
It explores Depression in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Depression in real-world context.
...
A real-world scenario shows how Depression impacts behaviour and decision making.
