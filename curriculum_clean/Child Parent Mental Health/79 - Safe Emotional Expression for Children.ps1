# ==================================================
# LESSON 79 - Safe Emotional Expression for Children
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "79"
    Title = "Safe Emotional Expression for Children"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Safe Emotional Expression for Children",
    ...
    Introduction = @'
This lesson explores Safe Emotional Expression for Children within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Safe Emotional Expression for Children
...
- Safe Emotional Expression for Children explanation
