# ==================================================
# LESSON 14 - Early Childhood - Lesson 4
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "14"
    Title = "Early Childhood - Lesson 4"
...
It explores Early Childhood in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Early Childhood in real-world context.
...
A real-world scenario shows how Early Childhood impacts behaviour and decision making.
