# ==================================================
# LESSON 45 - Healthy Discipline Without Harm
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "45"
    Title = "Healthy Discipline Without Harm"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Healthy Discipline Without Harm",
    ...
    Introduction = @'
This lesson explores Healthy Discipline Without Harm within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Healthy Discipline Without Harm
...
- Healthy Discipline Without Harm explanation
