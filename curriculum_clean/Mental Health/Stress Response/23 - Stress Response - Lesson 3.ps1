# ==================================================
# LESSON 23 - Stress Response - Lesson 3
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "23"
    Title = "Stress Response - Lesson 3"
...
It explores Stress Response in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Stress Response in real-world context.
...
A real-world scenario shows how Stress Response impacts behaviour and decision making.
