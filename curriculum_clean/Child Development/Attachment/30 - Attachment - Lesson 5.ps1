# ==================================================
# LESSON 30 - Attachment - Lesson 5
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "30"
    Title = "Attachment - Lesson 5"
    Category = "Attachment"
...
It explores Attachment in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Attachment in real-world context.
...
A real-world scenario shows how Attachment impacts behaviour and decision making.
