# ==================================================
# LESSON 11 - Coercive Control - Lesson 1
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "11"
    Title = "Coercive Control - Lesson 1"
...
It explores Coercive Control in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Coercive Control in real-world context.
...
A real-world scenario shows how Coercive Control impacts behaviour and decision making.
