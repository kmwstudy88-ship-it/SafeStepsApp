# ==================================================
# LESSON 87 - Digital Stress in Children
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "87"
    Title = "Digital Stress in Children"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Digital Stress in Children",
    ...
    Introduction = @'
This lesson explores Digital Stress in Children within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Digital Stress in Children
...
- Digital Stress in Children explanation
