# ==================================================
# LESSON 92 - Parenting ADHD Emotional Challenges
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "92"
    Title = "Parenting ADHD Emotional Challenges"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Parenting ADHD Emotional Challenges",
    ...
    Introduction = @'
This lesson explores Parenting ADHD Emotional Challenges within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Parenting ADHD Emotional Challenges
...
- Parenting ADHD Emotional Challenges explanation
