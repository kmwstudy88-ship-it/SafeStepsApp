# ==================================================
# LESSON 19 - Emotional Regulation - Lesson 4
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "19"
    Title = "Emotional Regulation - Lesson 4"
...
It explores Emotional Regulation in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Emotional Regulation in real-world context.
...
A real-world scenario shows how Emotional Regulation impacts behaviour and decision making.
