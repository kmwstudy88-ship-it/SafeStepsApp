# ==================================================
# LESSON 4 - Introduction to AOD - Lesson 4
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "4"
    Title = "Introduction to AOD - Lesson 4"
    Category = "Introduction to AOD"
    Module = "Alcohol and Other Drugs"
    Level = "Auto Generated"
    Duration = "3–6 Hours"

    LearningObjectives = @(
        "Understand Introduction to AOD",
...
It explores Introduction to AOD in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Introduction to AOD in real-world context.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Introduction to AOD

A real-world scenario shows how Introduction to AOD impacts behaviour and decision making.
...
- Introduction to AOD understanding
- Behavioural impact
- Risk factors
