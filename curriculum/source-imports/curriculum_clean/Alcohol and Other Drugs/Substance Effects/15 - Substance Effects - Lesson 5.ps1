# ==================================================
# LESSON 15 - Substance Effects - Lesson 5
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "15"
    Title = "Substance Effects - Lesson 5"
...
It explores Substance Effects in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Substance Effects in real-world context.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Substance Effects

A real-world scenario shows how Substance Effects impacts behaviour and decision making.
...
- Substance Effects understanding
- Behavioural impact
- Risk factors
