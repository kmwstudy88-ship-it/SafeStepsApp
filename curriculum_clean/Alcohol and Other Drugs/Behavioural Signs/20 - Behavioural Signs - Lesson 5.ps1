# ==================================================
# LESSON 20 - Behavioural Signs - Lesson 5
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "20"
    Title = "Behavioural Signs - Lesson 5"
...
It explores Behavioural Signs in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Behavioural Signs in real-world context.
...
A real-world scenario shows how Behavioural Signs impacts behaviour and decision making.
...
- Behavioural Signs understanding
- Behavioural impact
- Risk factors
