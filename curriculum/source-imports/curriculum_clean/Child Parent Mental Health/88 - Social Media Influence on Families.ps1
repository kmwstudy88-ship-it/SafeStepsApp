# ==================================================
# LESSON 88 - Social Media Influence on Families
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "88"
    Title = "Social Media Influence on Families"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Social Media Influence on Families",
    ...
    Introduction = @'
This lesson explores Social Media Influence on Families within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Social Media Influence on Families
...
- Social Media Influence on Families explanation
