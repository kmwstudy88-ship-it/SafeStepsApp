# ==================================================
# LESSON 48 - Relapse Prevention - Lesson 3
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "48"
    Title = "Relapse Prevention - Lesson 3"
...
It explores Relapse Prevention in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Relapse Prevention in real-world context.
...
A real-world scenario shows how Relapse Prevention impacts behaviour and decision making.
