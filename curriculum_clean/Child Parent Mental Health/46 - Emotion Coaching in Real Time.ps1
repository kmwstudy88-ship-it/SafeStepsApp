# ==================================================
# LESSON 46 - Emotion Coaching in Real Time
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "46"
    Title = "Emotion Coaching in Real Time"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Emotion Coaching in Real Time",
    ...
    Introduction = @'
This lesson explores Emotion Coaching in Real Time within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Emotion Coaching in Real Time
...
- Emotion Coaching in Real Time explanation
