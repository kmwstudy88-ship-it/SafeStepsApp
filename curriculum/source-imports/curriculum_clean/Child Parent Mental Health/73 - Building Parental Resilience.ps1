# ==================================================
# LESSON 73 - Building Parental Resilience
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "73"
    Title = "Building Parental Resilience"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Building Parental Resilience",
    ...
    Introduction = @'
This lesson explores Building Parental Resilience within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Building Parental Resilience
...
- Building Parental Resilience explanation
