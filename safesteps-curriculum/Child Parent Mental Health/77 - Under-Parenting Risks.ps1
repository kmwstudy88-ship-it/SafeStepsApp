# ==================================================
# LESSON 77 - Under-Parenting Risks
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "77"
    Title = "Under-Parenting Risks"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Under-Parenting Risks",
    ...
    Introduction = @'
This lesson explores Under-Parenting Risks within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Under-Parenting Risks
...
- Under-Parenting Risks explanation
