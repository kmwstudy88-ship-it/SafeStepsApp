# ==================================================
# LESSON 74 - Healthy Boundaries Between Parent and Child
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "74"
    Title = "Healthy Boundaries Between Parent and Child"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Healthy Boundaries Between Parent and Child",
    ...
    Introduction = @'
This lesson explores Healthy Boundaries Between Parent and Child within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Healthy Boundaries Between Parent and Child
...
- Healthy Boundaries Between Parent and Child explanation
