# ==================================================
# LESSON 21 - Adolescence - Lesson 1
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "21"
    Title = "Adolescence - Lesson 1"
...
It explores Adolescence in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Adolescence in real-world context.
...
A real-world scenario shows how Adolescence impacts behaviour and decision making.
