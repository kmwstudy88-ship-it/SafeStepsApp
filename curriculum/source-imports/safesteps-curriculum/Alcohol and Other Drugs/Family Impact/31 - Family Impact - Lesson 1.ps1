# ==================================================
# LESSON 31 - Family Impact - Lesson 1
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "31"
    Title = "Family Impact - Lesson 1"
...
It explores Family Impact in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Family Impact in real-world context.
...
A real-world scenario shows how Family Impact impacts behaviour and decision making.
