# ==================================================
# LESSON 68 - Child Anxiety From Family Stress
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "68"
    Title = "Child Anxiety From Family Stress"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Child Anxiety From Family Stress",
    ...
    Introduction = @'
This lesson explores Child Anxiety From Family Stress within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Child Anxiety From Family Stress
...
- Child Anxiety From Family Stress explanation
