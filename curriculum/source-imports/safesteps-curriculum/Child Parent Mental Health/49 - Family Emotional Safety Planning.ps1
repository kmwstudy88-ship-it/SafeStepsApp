# ==================================================
# LESSON 49 - Family Emotional Safety Planning
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "49"
    Title = "Family Emotional Safety Planning"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Family Emotional Safety Planning",
    ...
    Introduction = @'
This lesson explores Family Emotional Safety Planning within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Family Emotional Safety Planning
...
- Family Emotional Safety Planning explanation
