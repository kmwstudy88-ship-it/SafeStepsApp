# ==================================================
# LESSON 43 - Child Emotional Shutdown Responses
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "43"
    Title = "Child Emotional Shutdown Responses"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Child Emotional Shutdown Responses",
    ...
    Introduction = @'
This lesson explores Child Emotional Shutdown Responses within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Child Emotional Shutdown Responses
...
- Child Emotional Shutdown Responses explanation
