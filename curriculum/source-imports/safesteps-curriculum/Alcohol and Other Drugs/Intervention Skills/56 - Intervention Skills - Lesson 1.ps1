# ==================================================
# LESSON 56 - Intervention Skills - Lesson 1
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "56"
    Title = "Intervention Skills - Lesson 1"
    Category = "Intervention Skills"
    Module = "Alcohol and Other Drugs"
    Level = "Auto Generated"
    Duration = "3–6 Hours"

    LearningObjectives = @(
        "Understand Intervention Skills",
...
It explores Intervention Skills in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Intervention Skills in real-world context.
...
A real-world scenario shows how Intervention Skills impacts behaviour and decision making.
...
- Intervention Skills understanding
- Behavioural impact
- Risk factors
