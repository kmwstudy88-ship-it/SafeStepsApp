# ==================================================
# LESSON 4 - Self Awareness - Lesson 4
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "4"
    Title = "Self Awareness - Lesson 4"
...
It explores Self Awareness in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Self Awareness in real-world context.
...
A real-world scenario shows how Self Awareness impacts behaviour and decision making.
