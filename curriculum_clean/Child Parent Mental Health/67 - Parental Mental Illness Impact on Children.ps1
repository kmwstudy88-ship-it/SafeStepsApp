# ==================================================
# LESSON 67 - Parental Mental Illness Impact on Children
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "67"
    Title = "Parental Mental Illness Impact on Children"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Parental Mental Illness Impact on Children",
    ...
    Introduction = @'
This lesson explores Parental Mental Illness Impact on Children within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Parental Mental Illness Impact on Children
...
- Parental Mental Illness Impact on Children explanation
