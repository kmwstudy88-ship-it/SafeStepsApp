# ==================================================
# LESSON 75 - Avoiding Enmeshment in Families
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "75"
    Title = "Avoiding Enmeshment in Families"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Avoiding Enmeshment in Families",
    ...
    Introduction = @'
This lesson explores Avoiding Enmeshment in Families within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Avoiding Enmeshment in Families
...
- Avoiding Enmeshment in Families explanation
