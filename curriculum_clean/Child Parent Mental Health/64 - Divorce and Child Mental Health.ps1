# ==================================================
# LESSON 64 - Divorce and Child Mental Health
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "64"
    Title = "Divorce and Child Mental Health"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Divorce and Child Mental Health",
    ...
    Introduction = @'
This lesson explores Divorce and Child Mental Health within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Divorce and Child Mental Health
...
- Divorce and Child Mental Health explanation
