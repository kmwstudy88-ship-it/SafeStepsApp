-- SAFE STEPS COURT REPORT SNAPSHOTS REPAIR
-- Replays the immutable report snapshot table because the original timestamp
-- was marked applied before the migration body existed remotely.
