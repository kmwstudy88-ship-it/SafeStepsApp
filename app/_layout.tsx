                  ...
                  <SafetyProvider>
                    <EvidenceProvider>
                      <Stack screenOptions={{ headerShown: false }}>
                        ...
                        <Stack.Screen name="support-guide/index" />
                        <Stack.Screen name="parenting-coach/index" />
                        <Stack.Screen name="family-bridge/index" />
                        <Stack.Screen name="personal-ai-support/index" />
                        <Stack.Screen name="personal-ai-memory" />
                        <Stack.Screen name="admin/personal-ai-handoffs" />
                        <Stack.Screen name="admin/personal-ai-flow-versions" />
                        <Stack.Screen name="admin/personal-ai-incidents" />
                        <Stack.Screen name="admin/personal-ai-launch-readiness" />
                        <Stack.Screen name="admin/personal-ai-referrals" />
                        <Stack.Screen name="personal-ai-mood-trends" />
                        ...
                        <Stack.Screen name="referral-support" />
