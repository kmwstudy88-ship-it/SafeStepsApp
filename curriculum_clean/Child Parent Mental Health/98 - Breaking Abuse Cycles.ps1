# ==================================================
# LESSON 98 - Breaking Abuse Cycles
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "98"
    Title = "Breaking Abuse Cycles"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Breaking Abuse Cycles",
    ...
    Introduction = @'
This lesson explores Breaking Abuse Cycles within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Breaking Abuse Cycles
...
- Breaking Abuse Cycles explanation
