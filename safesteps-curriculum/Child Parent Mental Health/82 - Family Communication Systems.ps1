# ==================================================
# LESSON 82 - Family Communication Systems
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "82"
    Title = "Family Communication Systems"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Family Communication Systems",
    ...
    Introduction = @'
This lesson explores Family Communication Systems within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Family Communication Systems
...
- Family Communication Systems explanation
