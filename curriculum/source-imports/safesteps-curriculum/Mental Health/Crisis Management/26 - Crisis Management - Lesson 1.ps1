# ==================================================
# LESSON 26 - Crisis Management - Lesson 1
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "26"
    Title = "Crisis Management - Lesson 1"
...
It explores Crisis Management in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Crisis Management in real-world context.
...
A real-world scenario shows how Crisis Management impacts behaviour and decision making.
