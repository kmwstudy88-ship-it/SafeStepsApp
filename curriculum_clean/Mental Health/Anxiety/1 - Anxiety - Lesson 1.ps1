# ==================================================
# LESSON 1 - Anxiety - Lesson 1
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "1"
    Title = "Anxiety - Lesson 1"
    Category = "Anxiety"
...
It explores Anxiety in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Anxiety in real-world context.
...
A real-world scenario shows how Anxiety impacts behaviour and decision making.
