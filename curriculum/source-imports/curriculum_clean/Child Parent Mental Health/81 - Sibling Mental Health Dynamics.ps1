# ==================================================
# LESSON 81 - Sibling Mental Health Dynamics
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "81"
    Title = "Sibling Mental Health Dynamics"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Sibling Mental Health Dynamics",
    ...
    Introduction = @'
This lesson explores Sibling Mental Health Dynamics within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Sibling Mental Health Dynamics
...
- Sibling Mental Health Dynamics explanation
