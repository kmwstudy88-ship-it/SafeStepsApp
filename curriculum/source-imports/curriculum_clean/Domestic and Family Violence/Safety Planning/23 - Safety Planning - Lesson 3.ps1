# ==================================================
# LESSON 23 - Safety Planning - Lesson 3
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "23"
    Title = "Safety Planning - Lesson 3"
...
It explores Safety Planning in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Safety Planning in real-world context.
...
A real-world scenario shows how Safety Planning impacts behaviour and decision making.
