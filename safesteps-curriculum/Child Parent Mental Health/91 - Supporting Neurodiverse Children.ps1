# ==================================================
# LESSON 91 - Supporting Neurodiverse Children
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "91"
    Title = "Supporting Neurodiverse Children"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Supporting Neurodiverse Children",
    ...
    Introduction = @'
This lesson explores Supporting Neurodiverse Children within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Supporting Neurodiverse Children
...
- Supporting Neurodiverse Children explanation
