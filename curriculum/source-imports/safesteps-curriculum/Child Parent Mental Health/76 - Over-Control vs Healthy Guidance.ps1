# ==================================================
# LESSON 76 - Over-Control vs Healthy Guidance
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "76"
    Title = "Over-Control vs Healthy Guidance"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Over-Control vs Healthy Guidance",
    ...
    Introduction = @'
This lesson explores Over-Control vs Healthy Guidance within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Over-Control vs Healthy Guidance
...
- Over-Control vs Healthy Guidance explanation
