# ==================================================
# LESSON 57 - Breaking Reactive Parenting Patterns
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "57"
    Title = "Breaking Reactive Parenting Patterns"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Breaking Reactive Parenting Patterns",
    ...
    Introduction = @'
This lesson explores Breaking Reactive Parenting Patterns within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Breaking Reactive Parenting Patterns
...
- Breaking Reactive Parenting Patterns explanation
