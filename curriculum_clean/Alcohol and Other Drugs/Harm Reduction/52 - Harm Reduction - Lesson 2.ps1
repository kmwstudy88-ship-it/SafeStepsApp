# ==================================================
# LESSON 52 - Harm Reduction - Lesson 2
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "52"
    Title = "Harm Reduction - Lesson 2"
...
It explores Harm Reduction in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Harm Reduction in real-world context.
...
A real-world scenario shows how Harm Reduction impacts behaviour and decision making.
