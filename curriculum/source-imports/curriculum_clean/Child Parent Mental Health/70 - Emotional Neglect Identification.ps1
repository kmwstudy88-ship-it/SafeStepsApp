# ==================================================
# LESSON 70 - Emotional Neglect Identification
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "70"
    Title = "Emotional Neglect Identification"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Emotional Neglect Identification",
    ...
    Introduction = @'
This lesson explores Emotional Neglect Identification within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Emotional Neglect Identification
...
- Emotional Neglect Identification explanation
