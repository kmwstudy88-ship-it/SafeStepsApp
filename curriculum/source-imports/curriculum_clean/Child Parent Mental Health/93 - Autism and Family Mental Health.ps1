# ==================================================
# LESSON 93 - Autism and Family Mental Health
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "93"
    Title = "Autism and Family Mental Health"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Autism and Family Mental Health",
    ...
    Introduction = @'
This lesson explores Autism and Family Mental Health within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Autism and Family Mental Health
...
- Autism and Family Mental Health explanation
