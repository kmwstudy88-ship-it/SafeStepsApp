# ==================================================
# LESSON 44 - Repair After Emotional Rupture
# SAFE STEPS CHILD–PARENT MENTAL HEALTH
# ==================================================

$Lesson = @{
    LessonNumber = "44"
    Title = "Repair After Emotional Rupture"
    Category = "Child Parent Mental Health"
    Level = "Advanced"
    Duration = "4-6 Hours"

    LearningObjectives = @(
        "Understand Repair After Emotional Rupture",
    ...
    Introduction = @'
This lesson explores Repair After Emotional Rupture within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Repair After Emotional Rupture
...
- Repair After Emotional Rupture explanation
