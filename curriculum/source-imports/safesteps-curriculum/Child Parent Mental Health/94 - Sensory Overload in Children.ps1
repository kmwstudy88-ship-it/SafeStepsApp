# ==================================================
# LESSON 94 - Sensory Overload in Children
...
$Lesson = @{
    ...
    LearningObjectives = @(
        "Understand Sensory Overload in Children",
    ...
    Introduction = @'
This lesson explores Sensory Overload in Children within advanced family mental health systems.
...
'@
    ...
    CaseStudy = @'
CASE STUDY - Sensory Overload in Children
...
- Sensory Overload in Children explanation
