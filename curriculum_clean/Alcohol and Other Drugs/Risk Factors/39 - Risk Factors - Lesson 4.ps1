# ==================================================
# LESSON 39 - Risk Factors - Lesson 4
# SAFE STEPS CURRICULUM ENGINE GENERATED
# ==================================================

$Lesson = @{
    LessonNumber = "39"
    Title = "Risk Factors - Lesson 4"
...
It explores Risk Factors in a structured learning format
designed for behavioural development, support, and intervention.
'@

    MainContent = @'
SECTION 1 - OVERVIEW
Understanding Risk Factors in real-world context.
...
A real-world scenario shows how Risk Factors impacts behaviour and decision making.
